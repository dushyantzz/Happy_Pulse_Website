...
const categories: string[] = ['All', 'Infectious Disease', 'Chronic Disease', 'Cardiovascular', 'Mental Health', 'Oncology', 'Respiratory'];

// Define the initial diseases array
const diseases: Disease[] = [
  ...
  },
  {
    ...
    videoUrl: 'https://www.youtube.com/watch?v=vUVZtZjkUzY',
  ...
  },
  {
    ...
    videoUrl: 'https://www.youtube.com/watch?v=1i8ylq4j_EY',
...
const Education: React.FC = () => {
  ...
  // Filter diseases based on search term and selected category
