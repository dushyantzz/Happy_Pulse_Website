...
const preventionCards = [
  {
    icon: <Shield className="h-8 w-8 text-customGreen color-[#09B480]" />,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {preventionCards.map((card, index) => (
            ...
            >
              <div className="p-6">
                <div className="flex items-center justify-center w-12 h-12 bg-[#09B480] rounded-full mb-4">
                  {card.icon}
                </div>
                <h3 className="text-xl font-semibold text-[#09B480] mb-2">{card.title}</h3>
