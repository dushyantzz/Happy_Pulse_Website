                ...
                <div className="space-y-4">
                  {treatments.map((treatment) => (
                    <button
                      ...
                      className={`w-full text-left p-4 rounded-lg transition-colors duration-200 ${selectedTreatment.id === treatment.id
                          ? 'bg-blue-50 border-blue-400'
                          : 'bg-white hover:bg-gray-50 border-gray-200'
                        } border`}
                    >
                      <div className="flex items-center">
                        <div className={`${selectedTreatment.id === treatment.id ? 'text-blue-500' : 'text-gray-400'
                          }`}>
                          {treatment.icon}
                        </div>
                        <div className="ml-3">
                  ...
                  <div>
                    ...
                    <div className="bg-blue-50 rounded-lg p-4">
                      <div className="flex items-center mb-2">
                        ...
                        <span className="font-medium text-blue-700">Treatment Progress</span>
                      </div>
